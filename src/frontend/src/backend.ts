...
export class Backend implements backendInterface {
    ...
    async listFilesSharedWithMe(): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
    ...
    async shareFile(arg0: FileId, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.shareFile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unshareFile(arg0: FileId, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unshareFile(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FileMetadata_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileMetadata): Promise<FileMetadata> {
